> **이 skill은 on-demand로 사용합니다.**
> 코드 리뷰, 리팩토링, 코드 품질 개선 요청 시에만 참조합니다.
> 폴더 구조 관련 규칙은 이 프로젝트의 `rules/02-fsd.md`가 우선합니다.
> Props Drilling 해결책 중 Zustand/Jotai는 이 프로젝트에서 사용하지 않습니다 (`rules/05-frontend-conventions.md` 참조).
